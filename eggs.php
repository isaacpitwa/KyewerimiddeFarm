...
$fetch = "select * from eggs";
$data = mysqli_query($uzdb,$fetch);
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>Kyewelimidde|Feeding</title>
<meta charset="utf-8">
      ...
      <div class="wrapper">
        ...
        <nav>
          <ul id="menu">
            ...
            <li class="active"><a href="#">eggs</a></li>
            <li><a href="Egg Collection.html">Add Eggs</a></li>
        ...
        <div class="wrapper">
          ...
          <section class="col4 pad_left1">
            ...
            <ul id="why_us">
              <li><a href="index.html">Home</a></li>
             <li><a href="Expense.php">Expense</a></li>
              <li><a href="feeds.php.html">Feeding </a></li>
              <li><a href="#">Eggs report</a></li>
               <li><a href="sales.php">Sales</a></li>
              <li><a href="Egg Collection.html">New egg Collection</a></li>
              <li><a href="login.html">Logout </a></li>
            </ul>
          </section>
        </div>
